<div class="modal fade" id="confirmCommentDeletion" tabindex="-1" role="dialog" aria-labelledby="confirmCommentDeletion" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><spring:message code="commentConfirmDelete.title"/></h5>
