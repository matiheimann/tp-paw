...
<html>
	<head>
		<meta charset="UTF-8">
		<title>
			Pawddit | <spring:message code="verifiedAccount.title"/>
		</title>
		<meta name="description" content="<spring:message code="meta.description.confirmedaccount.message"/>">
	...
	<body class="main-font">
      ...
      <div class="center-content">
          ...
          <h4><spring:message code="verifiedAccount.message"/></h4>
