<div class="modal fade" id="confirmGroupDeletion" tabindex="-1" role="dialog" aria-labelledby="confirmGroupDeletion" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><spring:message code="groupConfirmDelete.title"/></h5>
