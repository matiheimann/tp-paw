...
define(['pawddit', 'services/messageService', 'services/restService', 'services/navbarService'], function(pawddit) {
	...
	pawddit.controller('ConfirmAccountCtrl', ['$scope', '$rootScope', '$route', '$location', '$translate', '$window', 'restService', 'navbarService', function($scope, $rootScope, $route, $location, $translate, $window, restServic, navbarService) {
