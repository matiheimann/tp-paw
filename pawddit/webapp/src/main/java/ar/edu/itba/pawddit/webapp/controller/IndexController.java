...
public class IndexController extends BaseController {
	...
	@RequestMapping("/")
	public ModelAndView index(@RequestParam(defaultValue = "1", value="page") int page, @ModelAttribute("user") final User user)
	{
		...
		if (user == null) {
			...
			mav.addObject("posts", ps.findBySubscriptions(user, POSTS_PER_PAGE, (page-1)*POSTS_PER_PAGE));
			mav.addObject("postsPage", page);
