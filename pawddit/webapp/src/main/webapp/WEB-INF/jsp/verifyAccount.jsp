...
<html>
	<head>
		<meta charset="UTF-8">
		<title>
			Pawddit | <spring:message code="verifyAccount.title"/>
		</title>
		<meta name="description" content="<spring:message code="meta.description.verifyaccount.message"/>">
	...
	<body class="main-font">
      ...
      <div class="center-content">
          ...
          <h4><spring:message code="verifyAccount.message"/></h4>
